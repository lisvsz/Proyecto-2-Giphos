...
class Stopwatch {
    constructor(state) {
        ...
        btnRecord.addEventListener("click", this.handleClickStart);
        this.handleClickStop = this.handleClickStop.bind(this);
        btnFinish.addEventListener("click", this.handleClickStop);
        this.handleClickReset = this.handleClickReset.bind(this);
        btnRepeat.addEventListener("click", this.handleClickReset);
    ...
    tick() {
        this.setState({
            difference: newDate(new Date() - this.state.startTimestamp)
        });
    ...
    handleClickStop() {
        cancelAnimationFrame(this-this.requestAnimationId);
        this.setState({
            startTimestamp: null,
